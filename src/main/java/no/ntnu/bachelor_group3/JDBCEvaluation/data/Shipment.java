...
public class Shipment {
    ...
    // Constructor
    public Shipment(int id, Customer sender, Customer receiver, Customer payer, double totalCost) {
        this.id = id;
        this.sender = sender;
    ...
    public static Shipment getShipmentById(int shipmentId, Connection conn) throws SQLException {
        ...
        if (rs.next()) {
            ...
            Shipment shipment = new Shipment(rs.getInt("id"), sender, receiver, payer, rs.getDouble("total_cost"));
